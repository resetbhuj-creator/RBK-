...
export const MENU_ITEMS: MenuItem[] = [
  ...
  {
    id: MainMenuType.ADMINISTRATION,
  ...
  {
    id: MainMenuType.COMMUNICATION,
    label: 'Print/Email/SMS',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const COMPANY_SUB_MENUS: SubMenuItem[] = [
  {
    id: CompanySubMenu.OPEN_COMPANY,
    label: 'Open Company',
    description: 'Select and load an existing company profile from the database.',
    color: 'bg-blue-500',
    icon: (
  ...
  {
    id: CompanySubMenu.CREATE_COMPANY,
    label: 'Create Company',
    description: 'Initialize a new company structure with basic configurations.',
  ...
  {
    id: CompanySubMenu.EDIT_COMPANY,
    label: 'Edit Company',
    description: 'Modify active company identity, statutory details, and brand visuals.',
    color: 'bg-indigo-500',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: CompanySubMenu.RESTORE_COMPANY,
    label: 'Restore Company',
    description: 'Reintegrate historical company data from a specified directory path or archive.',
    color: 'bg-violet-600',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: CompanySubMenu.ADD_YEAR,
    label: 'Add New Year',
    description: 'Provision a new financial cycle for the active company profile.',
    color: 'bg-indigo-600',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: CompanySubMenu.SPLIT_YEAR,
    label: 'Split Financial Year',
    description: 'Archive current data and start a fresh financial cycle.',
    color: 'bg-amber-500',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
  ...
  {
    id: CompanySubMenu.DELETE_COMPANY,
    label: 'Delete Company / Year Wise',
    description: 'Permanently remove company data or specific financial years.',
    color: 'bg-rose-500',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ADMINISTRATION_SUB_MENUS: SubMenuItem[] = [
  {
    id: AdminSubMenu.MASTERS,
    label: 'Masters',
    description: 'Manage Account Ledgers, Item Catalogues, and Tax Configurations.',
    color: 'bg-indigo-600',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: AdminSubMenu.USERS,
    label: 'Users',
    description: 'Provision new system users and define role-based access control.',
    color: 'bg-blue-600',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: AdminSubMenu.BACKUP,
    label: 'Backup',
    description: 'Initialize secure database dumps and review backup history logs.',
  ...
  {
    id: AdminSubMenu.YEAR_CHANGE,
    label: 'Year Change',
    description: 'Rapidly switch the active working period context.',
    color: 'bg-rose-600',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
...
export const TRANSACTION_SUB_MENUS: SubMenuItem[] = [
  {
  ...
  {
    id: TransactionSubMenu.BANK_RECONCILIATION,
    label: 'Bank Reconciliation',
    description: 'Synchronize book entries with verified bank statement dates.',
    color: 'bg-blue-600',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: TransactionSubMenu.DAY_BOOK,
    label: 'Day Book',
    description: 'Chronological view of all transactions for the day.',
    color: 'bg-amber-600',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const DISPLAY_SUB_MENUS: SubMenuItem[] = [
  {
    id: DisplaySubMenu.BALANCE_SHEET,
    label: 'Balance Sheet',
    description: 'Financial position as of current date.',
    color: 'bg-indigo-600',
    icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
  },
  {
    id: DisplaySubMenu.PROFIT_LOSS,
    label: 'Profit & Loss',
    description: 'Income statement for active period.',
    color: 'bg-emerald-600',
    icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
  },
  {
    id: DisplaySubMenu.BUDGET_VARIANCE,
    label: 'Budget Variance',
    description: 'Analyze Actual spending vs projected Budget.',
    color: 'bg-violet-600',
  ...
  {
    id: DisplaySubMenu.TRIAL_BALANCE,
    label: 'Trial Balance',
    description: 'Verification of ledger debits and credits.',
    color: 'bg-blue-600',
    icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
  },
  {
    id: DisplaySubMenu.CASH_FLOW,
    label: 'Cash Flow',
    description: 'Analysis of liquidity movements.',
    color: 'bg-amber-600',
    icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" /></svg>
  },
  {
    id: DisplaySubMenu.LEDGER_REPORT,
    label: 'Ledger Statement',
    description: 'Audit a single ledger account with running balance.',
    color: 'bg-indigo-700',
    icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
  },
  {
    id: DisplaySubMenu.OUTSTANDING_REPORT,
    label: 'Bills Outstanding',
    description: 'Track payables and receivables with ageing logic.',
    color: 'bg-rose-700',
  ...
  {
    id: DisplaySubMenu.INVENTORY_SUMMARY,
    label: 'Inventory Summary',
    description: 'Stock status and valuation report.',
    color: 'bg-rose-600',
    icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
  },
  {
    id: DisplaySubMenu.GST_REPORTS,
    label: 'GST Reports',
